...
TEST(DataLoader, LoadMNIST) {
  ...
  auto array_test =
      loadMNIST<LinearArray<float, 28 * 28>>("../../../test/featuretest/datasets/mnist/test", MNISTDataSet::TEST);
  auto mtrx_test =
      loadMNIST<LinearArray<float, 28, 28>>("../../../test/featuretest/datasets/mnist/test", MNISTDataSet::TEST);
  ...
  auto array_train =
      loadMNIST<LinearArray<float, 28 * 28>>("../../../test/featuretest/datasets/mnist/train", MNISTDataSet::TRAIN);
  auto mtrx_train =
      loadMNIST<LinearArray<float, 28, 28>>("../../../test/featuretest/datasets/mnist/train", MNISTDataSet::TRAIN);
